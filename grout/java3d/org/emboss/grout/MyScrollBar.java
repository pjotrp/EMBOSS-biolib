...
public class MyScrollBar extends JPanel implements java.io.Serializable 
{
		...
		{
				// System.out.println("value = " + value + " extent = " + extent + " min = " + min + " max = " + max + " bar.value = " + bar.getValue() + " bar.getExtent = " + bar.getVisibleAmount() + " bar.getMinimum = " + bar.getMinimum() + " bar.getMaximum = " + bar.getMaximum());
		}
		...
		public static double convertValueToRequiredNumber(MyScrollBar val)
		{
				...
				{
						System.err.println("Unknown orientation, please use VERTICAL or HORIZONTAL");
						return 0;
				}
		}
