...
public class ResListView 
{

  final Cursor cbusy = new Cursor(Cursor.WAIT_CURSOR);
  final Cursor cdone = new Cursor(Cursor.DEFAULT_CURSOR);

  public ResListView(final EmbreoParams mysettings, final EmbreoPendingResults epr) throws EmbreoAuthException
  {
    ...
    savedResFrame = new JFrame("Results on Server");
    ...
    JScrollPane aboutScroll = new JScrollPane(aboutRes);
    ...
    JMenuItem resFileMenuUpdate = new JMenuItem("Update List",KeyEvent.VK_U);
