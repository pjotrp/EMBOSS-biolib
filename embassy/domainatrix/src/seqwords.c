...
**  a file in embl-like format of sequences whose swissprot entries contains at 
**  least one of the keywords.  If an entry contains a keyword in a domain 
**  record of the feature table, then the sequence of the domain is written to 
**  the output file, otherwise the entire sequence is written.  The user must
**  provide the name of the swissprot database sequece database to search.
**
**  
**   
**  Sister applications
...
**  
**  Notes
**  The output file is in exactly the same format as the scop hits file 
**  generated by seqsearch.
**  
**  
**  
**  
...
**  swissprot database /test_data/test.seq.  The scop hits file 
**  /test_data/test.seqhits containing the results of the search was written.
**  
**  The following command line would achieve the same result.
**  seqwords /test_data/test.terms /test_data/test.seqhits -spfile /test_data/test.seq
**  
**  
**  
**  Input file format
...
**
**  Excerpt from seqwords input file
**  
...
/* @prog seqwords *******************************************************
**
** Generate files of hits for scop families by searching swissprot with 
** keywords.
**
******************************************************************************/
