...
"$Id: splice.c,v 1.1 2002/02/25 09:33:50 hgmp Exp $";
#endif

static int spl_encode[NACHARS];
static int encodeInit;

signal_t gt = {{0, 0, 0, 2, 0},{0, 0, 0, 2, 0},{2, 2, 2, 5, 2},{0, 0, 0, 2, 0},{0, 0, 0, 2, 0}};
...
signal_t ac = {{2, 5, 2, 2, 2},{0, 2, 0, 0, 0},{0, 2, 0, 0, 0},{0, 2, 0, 0, 0},{0, 2, 0, 0, 0}};
