...
/* 
Because of the need to replace the standard C output functions
with Ajax functions printf is removed and only fprintf is utilized.
It takes the same argument list as AjFmtPrintF. 
Any globals in the next session are actually allocated in
sim4.init.c 
*/
#ifdef    EMBASSY
...
extern AjPSeq     esim4_rsequence;
extern AjPSeq     esim4_genome;
