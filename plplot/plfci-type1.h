...
const FCI_to_FontName_Table Type1Lookup[N_Type1Lookup] = {
     ...
     {PL_FCI_MARK | 0x003, (const unsigned char *)"Times-Roman"},
     {PL_FCI_MARK | 0x004, (const unsigned char *)"Symbol"},
     ...
     {PL_FCI_MARK | 0x013, (const unsigned char *)"Times-Italic"},
     {PL_FCI_MARK | 0x014, (const unsigned char *)"Symbol"},
     ...
     {PL_FCI_MARK | 0x023, (const unsigned char *)"Times-Italic"},
     {PL_FCI_MARK | 0x024, (const unsigned char *)"Symbol"},
     ...
     {PL_FCI_MARK | 0x103, (const unsigned char *)"Times-Bold"},
     {PL_FCI_MARK | 0x104, (const unsigned char *)"Symbol"},
     ...
     {PL_FCI_MARK | 0x113, (const unsigned char *)"Times-BoldItalic"},
     {PL_FCI_MARK | 0x114, (const unsigned char *)"Symbol"},
     ...
     {PL_FCI_MARK | 0x123, (const unsigned char *)"Times-BoldItalic"},
     {PL_FCI_MARK | 0x124, (const unsigned char *)"Symbol"}
};
