...
sub writeOutput {
    ...
    $output =~ s/CreationDate: ... ... \d\d [0-9:]+ 2[0-9][0-9][0-9]$/CreationDate: Sat Jul 15 12:00:00 2006/go;
    $output =~ s/Rundate: ... ... \d\d 2[0-9][0-9][0-9] [0-9:]+$/Rundate: Sat Jul 15 2006 12:00:00/go;
