    ...
    {  
        ...
        else
        {
            ...
            if(*p=='F')
            {
                ...
                if((ajStrChar(smpfextn, 0)!='.'))        /* checks if the file extension starts with "." */
            ...
            else if(*p=='G')
            {
                ...
                /* create an output filename */
                /* Add a '.' to outextn if one does not already exist */
                if((ajStrChar(gbpfextn, 0)!='.'))        /* checks if the file extension starts with "." */
            ...
            else if(*p=='H')
            {
                /* create an output filename */
                /* Add a '.' to outextn if one does not already exist */
                if((ajStrChar(hnpfextn, 0)!='.'))        /* checks if the file extension starts with "." */
