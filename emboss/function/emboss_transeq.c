/* @source emboss_transeq application
**
...
/* @func transeq **************************************************************
**
** Translate nucleic acid sequences. This is the full function called from
** both the transeq binary and (potential) external interfaces without the
** ACD interfaces. This function contains the base functional logic. Note 
** that the name is exactly the binary name, and the parameters are exactly
** the parameters used. I.e. the documentation matches for both the 
** interfaces.
**
** @param  FIXME
** @return FIXME
...
/* @func transeq_acd *********************************************************
**
** This is the function that get called from main and loads the ACD 
**
******************************************************************************/
...
int transeq_acd(int argc, char **argv)
{
    ...
    seqout = transeq(seqall, framelist, tablename, regions, trim, clean, alternate);
...
/* @func emboss_transeq *******************************************************
**
** Translate nucleic acid sequences. This is the simplified function for 
** external interfaces, which does not use ACD. NOTE: I would prefer the 
** naming *not* to comply with other EMBOSS interfaces. Just standard C.
**
** @param  table number; input nucleotide sequence
** @return list of translated amino acid sequences
** @@
******************************************************************************/
