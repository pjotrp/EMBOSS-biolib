/* @source nawalignrunner application
**
** Runs EMBOSS alignment program nawalign on all sequence pairs in given directory and
**  writes the resulting alignments into a new directory
**
** @author: Copyright (C) Damian Counsell
** @version $Revision: 1.1 $
** @modified $Date: 2004/10/27 17:54:54 $
** @@
**
...
/* @prog nawalignrunner ******************************************************
** 
** runs nawalign alignment program on a directory full of sequence pairs 
**
******************************************************************************/
...
int main( int argc , char **argv )
{
    ...
    embInit("nawalignrunner", argc, argv);
