...
static void copy_DLLs(char *basedir)
{
    ...
    sprintf(command,"cp -fR %s/emboss/win32/DLLs/ajax/acd.vcxproj "
    ...
    sprintf(command,"cp -fR %s/emboss/win32/DLLs/ajax/ajaxdb.vcxproj "
    ...
    sprintf(command,"cp -fR %s/emboss/win32/DLLs/ajax/ajaxg.vcxproj "
    ...
    sprintf(command,"cp -fR %s/emboss/win32/DLLs/ajax/core.vcxproj "
    ...
    sprintf(command,"cp -fR %s/emboss/win32/DLLs/ajax/ensembl.vcxproj "
    ...
    sprintf(command,"cp -fR %s/emboss/win32/DLLs/ajax/expat.vcxproj "
    ...
    sprintf(command,"cp -fR %s/emboss/win32/DLLs/ajax/zlib.vcxproj "
    ...
    sprintf(command,"cp -fR %s/emboss/win32/DLLs/ajax/pcre.vcxproj "
