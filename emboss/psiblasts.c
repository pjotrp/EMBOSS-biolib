...
** have a section containing an NN, ID, CL, RA and SQ records (see below) for 
...
** (9) ID - Database identifier code of the hit. 
** (10) TY - Classification of hit.  Has the value HIT (for sequences retrieved 
** by psi-blast) or ALIGN (if the sequence was included in the seed alignment). 
       	...
       	while(ajFileReadLine(seqf,&line))
	{
		...
		while(ajFileReadLine(seqf,&line))
		{
			...
			else
			{
				...
				{
				    ajFmtPrintF(families,"TY   ALIGN\nXX\n");
				    break;
				}
				else
				{
				    ajFmtPrintF(families,"TY   HIT\nXX\n");
				    break;
				}
			    }
