...
**
** (10) TY - Classification of hit.  Has the value PSIBLAST (for
** sequences retrieved by psi-blast) or TRAIN (if the sequence was
** included in the seed alignment).  (Files of this type are also
** generated by the EMBOSS application swissparse and may be be hand
** edited with additional sequences, in either case, the value OTHER
** will be given for this record).
**
** (11) RA - Sequence range. The numbers before START and END give the
...
**
** (12) SQ - protein sequence. The number of residues is given before
...
int main(int argc, char **argv)
{
    ...
    ajFileScan(align, temp, &list, ajFalse, ajFalse,
