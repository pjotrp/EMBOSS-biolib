...
F90_OBJS=.\Release/
CPP_PROJ=/nologo /MT /W3 /EHsc /O2 /D "_CRT_SECURE_NO_DEPRECATE" /D "WIN32" /D "NDEBUG" /D "_MBCS" /D "_LIB" /D "BUILD_DIR=$(BUILD_DIR)" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c
BSC32=bscmake.exe
...
F90_OBJS=.\Debug/
CPP_PROJ=/nologo /MTd /W3 /Gm /EHsc /ZI /Od /D "WIN32" /D "_DEBUG" /D "_MBCS" /D "_LIB" /D "_CRT_SECURE_NO_DEPRECATE" /D "BUILD_DIR=$(BUILD_DIR)"  /Fp"$(INTDIR)\plplib.pch"  /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /RTC1  /c
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\plplib.bsc"
BSC32_SBRS= \
